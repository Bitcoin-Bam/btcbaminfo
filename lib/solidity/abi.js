...
const brc20List = require('./brc20-abi.json')
const brc721List = require('./brc721-abi.json')
...
const brc20ABIs = transformABIList(brc20List)
const brc721ABIs = transformABIList(brc721List)

Object.assign(exports, {MethodABI, EventABI, brc20ABIs, brc721ABIs})
